...
export default function Register() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 text-slate-800 dark:text-white p-4 transition-colors duration-300">
            ...
            >
                <h2 className="text-3xl font-bold mb-6 text-center bg-gradient-to-r from-teal-500 to-emerald-500 bg-clip-text text-transparent">Create Account</h2>
                ...
                <p className="mt-6 text-center text-slate-500 dark:text-gray-400 text-sm">
                    Already have an account? <Link to="/login" className="text-teal-500 dark:text-teal-400 hover:text-teal-600 dark:hover:text-teal-300">Sign In</Link>
                </p>
            </motion.div>
        </div>
    );
